...
export class RegionFormComponent {
    ...
    protected readonly form = new FormGroup({
        ...
        doubleFloorHouse6: new FormControl<File | null>(null, Validators.required),
        thirdFloorHouse1: new FormControl<File | null>(null, Validators.required),
        workshop1: new FormControl<File | null>(null, Validators.required),
        workshop2: new FormControl<File | null>(null, Validators.required),
        blacksmithShop: new FormControl<File | null>(null, Validators.required),
        religionOrCultureOrEconomicHouse1: new FormControl<File | null>(null, Validators.required),
        religionOrCultureOrEconomicHouse2: new FormControl<File | null>(null, Validators.required),
        ...
        marketPlace3: new FormControl<File | null>(null, Validators.required),
        marketPlace4: new FormControl<File | null>(null, Validators.required),
        marketPlace5: new FormControl<File | null>(null, Validators.required),
        stablesOrHarbor: new FormControl<File | null>(null, Validators.required),
        tavern: new FormControl<File | null>(null, Validators.required),
        importantBuilding: new FormControl<File | null>(null, Validators.required),
        greateBuilding: new FormControl<File | null>(null, Validators.required),
        steelBuilding: new FormControl<File | null>(null, Validators.required),
    });
    ...
    protected getLabelForKey(key: FileKeyRegion): string {
        return {
            ...
            bigYardage: 'Расширенная площадь территории',
            pit: 'Колодец',
            ...
            religionOrCultureOrEconomicHouse1: 'Здание религии/культуры/экономики №1',
            religionOrCultureOrEconomicHouse2: 'Здание религии/культуры/экономики №2',
