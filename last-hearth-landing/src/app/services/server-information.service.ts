...
export class ServerInformationService {
    ...
    public getOnlinePlayersCount$(): Observable<{ count: number; max: number }> {
        return this.http.get<{ count: number; max: number }>(`${this.baseUrl}/players/count`);
    }

    // TODO: [TASK:#15]
    public getTime$(): Observable<{ formatted_time: string }> {
        return this.http.get<{ formatted_time: string }>(`${this.baseUrl}/time`);
    }
    ...
    public postQuestion(question: string) {
        ...
        return this.http.post<{ question: string }>(
    ...
    public getQuestions$(): Observable<IVerificationQuestion[]> {
        ...
        return this.http
            .get<{
                questions: Array<IVerificationQuestion>;
    ...
    public getVerifyRequests(): Observable<IVerifyRequest[]> {
        ...
        return this.http
            .get<{ requests: Array<IVerifyRequest> }>(`${this.baseUrl}/verifications`, { headers: headers })
    ...
    public getCode() {
        ...
        return this.http.get<{ code: string }>(`${this.baseUrl}/user/verify/code`, { headers: headers });
    }
