    ...
    public readonly news = [
        {
            ...
            image: '/5.png',
            description:
                'Пройдя все трудности и опередив всех, селение Люмерия получила статус города Сюзерена! Напоминаю, что любой может побороться за данный статус и успеть до начала следующего сезона набрать себе репутацию! Сообщаем, что новый, зимне-весенний сезон начнется 30.12.25!',
        },
        {
