    ...
    protected readonly titles: PrivilegeCard[] = [
        ...
        },
        {
            ...
            kitItems: [
                ...
                { hint: 'Седло', count: 1, image: '/images/title-items/saddle.webp' },
                { hint: 'Глубокий вальтрап дворянина', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Уздечка с трензельными поводьями', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Медальон вапити красный', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Прочные сдельные сумки', count: 1, image: '/images/title-items/goat.webp' },
            ],
            dailyKitItems: [
                { hint: 'Сильно сухие рисовые сухари', count: 32, image: '/images/title-items/goat.webp' },
                { hint: 'Медово-серная припарка из полотна', count: 8, image: '/images/title-items/goat.webp' },
                { hint: 'Ведро с 10л молока', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Темпоральный амулет', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Темпоральная шестеренка', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Серебряные монеты', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Огниво', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Скальная бомба', count: 1, image: '/images/title-items/goat.webp' },
                { hint: 'Ржавая шестеренка', count: 16, image: '/images/title-items/goat.webp' },
            ],
        },
    ];
