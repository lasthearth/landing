...
import { fileFields } from './village-form.types';
import { FileKeyVillage } from './village-form.types';
...
export class VillageFormComponent {
    ...
    public constructor() {
        setupSettlementDraft(this.form, this.fileFields, 'settlement-draft-village', this.destroyRef, this.localStorageService);
        ...
        this.onSubmit
            .pipe(
                ...
                switchMap((request) => {
                    clearSettlementDraft('settlement-draft-village', this.localStorageService);
