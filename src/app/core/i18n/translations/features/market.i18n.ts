export const MARKET_I18N = {
    ru: {
        market: {
            ...
            marketPage: {
                title: 'Магазин очага',
                subtitle:
                    'Титулы, наборы и особые предметы. Выдача на сервере в течение 24 часов после покупки.',
                balanceLabel: 'Ваш баланс',
                topUp: 'Пополнить',
                trustDelivery: 'Выдача за 24 часа',
                trustPayment: 'СБП и Boosty',
            ...
            purchaseDialog: {
                ...
                dailyContents: 'Каждый день',
                yourBalance: 'Ваш баланс',
                notEnough: 'Не хватает {{amount}} осколков',
                topUp: 'Пополнить осколки',
                delivery: 'Выдача на сервере в течение 24 часов',
                confirmation:
    ...
    en: {
        market: {
            ...
            marketPage: {
                title: 'Hearth Shop',
                subtitle: 'Titles, kits and special items. Delivered on the server within 24 hours.',
                balanceLabel: 'Your balance',
                topUp: 'Top up',
                trustDelivery: 'Delivery in 24 hours',
                trustPayment: 'SBP and Boosty',
            ...
            purchaseDialog: {
                ...
                abilities: 'Abilities',
                dailyContents: 'Every day',
                yourBalance: 'Your balance',
                notEnough: 'You need {{amount}} more shards',
                topUp: 'Top up shards',
                delivery: 'Delivered on the server within 24 hours',
                confirmation:
